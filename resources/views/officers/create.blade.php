    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="p-5 bg-white border-b border-gray-200">
            <div class="mb-2 border-b border-gray-200 pb-2">
                <h1 class="text-2xl font-bold text-gray-800">Add New Officer</h1>
                <p class="text-sm text-gray-500 mt-1">Enter the details for the new officer.</p>
            </div>
            ...
            <form method="POST" action="{{ route('officers.store') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="name" type="text"
                                ...
                                name="name" value="{{ old('name') }}" required autofocus placeholder="Enter officer's name">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input id="designation" type="text"
                                ...
                                name="designation" value="{{ old('designation') }}" placeholder="e.g. Manager, Clerk">
                            @error('designation')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input id="contact" type="text"
                                ...
                                name="contact" value="{{ old('contact') }}" placeholder="Enter contact number">
                            @error('contact')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mt-8 mb-4 border-b border-gray-200 pb-2">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Create an associated user account for this officer.</p>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="email" type="email"
                                ...
                                name="email" value="{{ old('email') }}" required autocomplete="new-email" placeholder="Enter user's email">
                            @error('email')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="employee_id" type="text"
                                ...
                                name="employee_id" value="{{ old('employee_id') }}" placeholder="Enter employee ID">
                            @error('employee_id')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        console.log('Officer Create Script loaded and DOM content loaded.'); // Added log
                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        data.forEach(department => {
                            ...
                            if (department.id == oldDepartmentId) {
        ...
        // Initial fetch on page load if a center is already selected (e.g., due to old input or pre-filled form)
        if (centerSelect && centerSelect.value) { // Added check
            console.log('Initial fetch for center:', centerSelect.value); // Added log
