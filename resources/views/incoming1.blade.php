    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="px-6 py-4 bg-[#00583A] border-b border-[#004028]">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-white">Applicant Receive</h1>
                    <p class="text-sm text-white mt-1">Manage all applicant incoming couriers and their details.</p>
                </div>
            </div>
            </div>
            ...
            <div class="mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                <div class="mb-4 border-b border-gray-200 pb-2">
                    <h2 class="text-lg font-bold text-gray-800">Register New Applicant Receive</h2>
                    <p class="text-sm text-gray-500">Enter the details of the applicant incoming courier package.</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input id="city" type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('city') border-red-500 @enderror" name="city" value="{{ old('city') }}" placeholder="Enter City">
                                @error('city')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
