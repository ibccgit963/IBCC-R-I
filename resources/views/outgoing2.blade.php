    ...
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-sm text-white mt-1">
                        @if(Auth::user()->role->slug === 'officer')
                            Submit internal dispatch requests to R&amp;I for processing.
                        @else
                            Manage all internal dispatches and their details.
                        @endif
                    </p>
                </div>
            </div>
        ...
        <div class="mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
            <div class="mb-4 border-b border-gray-200 pb-2">
                @if(Auth::user()->role->slug === 'officer')
                    <h2 class="text-lg font-bold text-gray-800">Submit Internal Dispatch Request</h2>
                    <p class="text-sm text-gray-500">Fill in the details and submit to R&amp;I for dispatch.</p>
                @else
                    <h2 class="text-lg font-bold text-gray-800">Create Internal Dispatch</h2>
                        ...
                        <tr>
                            <td colspan="{{ Auth::user()->role->slug !== 'officer' ? 9 : 8 }}" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-lg font-medium">No internal dispatches found.</p>
