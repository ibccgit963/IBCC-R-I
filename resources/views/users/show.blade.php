...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-4">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <div class="px-6 py-4 bg-[#00583A] border-b border-[#004028]">
            ...
            <p class="text-sm text-white mt-1">View the details of the system user.</p>
        </div>
        ...
        <div class="p-5 bg-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Employee ID -->
                    <div>
                        <label class="block font-medium text-sm text-gray-700">Employee ID</label>
                        <div class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 bg-gray-50 sm:text-sm text-gray-700">
                            {{ $user->employee_id }}
                        </div>
                    </div>
                ...
                <div class="space-y-3">
                    ...
                    <!-- Center -->
                    <div>
                        <label class="block font-medium text-sm text-gray-700">Center</label>
                        <div class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 bg-gray-50 sm:text-sm text-gray-700">
